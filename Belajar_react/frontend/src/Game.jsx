...
// Konfigurasi Game
const TOTAL_GAME_TIME = 120; // 2 Menit
    ...
    <Container maxWidth="sm" sx={{ py: 4 }}>
      ...
      <Dialog open={gameState === "MENU"} maxWidth="xs" fullWidth>
        ...
        <DialogContent>
          <Typography variant="body1" color="text.secondary" textAlign="center" sx={{ mb: 3 }}>
            Game berlangsung selama 2 Menit.
          </Typography>
          <TextField
            fullWidth
      ...
      <Dialog open={gameState === "FINISHED"} maxWidth="xs" fullWidth>
        ...
        <DialogContent sx={{ textAlign: 'center' }}>
          ...
          <Typography variant="h1" color="error" fontWeight="bold" sx={{ my: 3 }}>
            {score}
          </Typography>
          <Typography variant="body2" color="text.secondary">
      ...
      >
        ...
        >
          ...
          <Box sx={{ display: 'flex' }}>
            ...
            {/* Fill empty cells */}
            {PRESETS.length < 10 && Array.from({ length: 10 - PRESETS.length }).map((_, i) => (
              <Box
                key={`empty-${i}`}
                sx={{
                  flex: 1,
                  py: 2,
                  borderRight: i < (4 - (PRESETS.length - 5)) ? 1 : 0,
                  borderColor: 'divider',
                }}
              />
            ))}
